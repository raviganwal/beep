...
class DailyStatsView extends StatefulWidget {
  const DailyStatsView({Key? key}) : super(key: key);
...
class _DailyStatsViewState extends State<DailyStatsView> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemCount: machineViewModel.dailyStatsList.length,
      itemBuilder: (context, index) {
        DailyStats dailyStats =
            machineViewModel.dailyStatsList.elementAt(index);
        return Column(
          children: [
            Row(
              children: [
                ...
                Text(
                  dailyStats.statDate.toString().toyyyyMMddParse.toEEEMMMdd,
